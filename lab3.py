...
def modify_element_property(build_ele, name, value):
    ...
    if (name == "Height"):
        ...
        build_ele.Height.value = value + build_ele.RibHeight.value + build_ele.BotShUpHeight.value + build_ele.BotShLowHeight.value
    elif (name == "RibHeight"):
        build_ele.Height.value = value + build_ele.TopShHeight.value + build_ele.BotShUpHeight.value + build_ele.BotShLowHeight.value
    elif (name == "BotShUpHeight"):
        build_ele.Height.value = value + build_ele.TopShHeight.value + build_ele.RibHeight.value + build_ele.BotShLowHeight.value
        ...
        build_ele.Height.value = value + build_ele.TopShHeight.value + build_ele.RibHeight.value + build_ele.BotShUpHeight.value
        ...
        if (value > build_ele.Height.value - build_ele.TopShHeight.value - 45.5):
            build_ele.HoleHeight.value = build_ele.Height.value - build_ele.TopShHeight.value - 45.5
        ...
        if (value >= build_ele.Length.value / 2.):
            build_ele.HoleDepth.value = build_ele.Length.value / 2. - 45.5
